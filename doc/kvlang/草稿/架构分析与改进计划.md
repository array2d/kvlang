...
| 位置 | 内容 |
|------|------|
| `internal/keytree/src.go` | `SrcFuncLine`，零调用方 |
...
#### 3.4.3 `copyFunc` O(N×M) KV 操作——每次函数调用的主要开销
