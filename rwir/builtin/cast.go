...
func evalCast(kind string, inputs []kvspace.XValue) (kvspace.XValue, error) {
	...
	case "int8":    return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewInt8(int8(asInt(v))) })
	case "int16":   return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewInt16(int16(asInt(v))) })
	case "int32":   return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewInt32(int32(asInt(v))) })
	case "int64":   return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewInt64(asInt(v)) })
	case "uint8":   return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewUint8(uint8(asInt(v))) })
	case "uint16":  return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewUint16(uint16(asInt(v))) })
	case "uint32":  return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewUint32(uint32(asInt(v))) })
	case "uint64":  return castNum(inputs, func(v kvspace.XValue) kvspace.XValue { return kvspace.NewUint64(uint64(asInt(v))) })
