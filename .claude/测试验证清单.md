...
| 示例文件存在 | `ls example/kvlang/builtin/print/print_int.kv` | 文件存在 |
...
| # | 命令 | 期望 |
|---|------|------|
| 3.1 | `./kvlang kvspace clear && ./kvlang load example/kvlang/builtin/print/print_int.kv` | 含 `loaded 1 file(s)` |
| 3.2 | 接上：`./kvlang kvspace get /func/main` | 含 `"entry":"pre_main"` |
| 3.3 | 接上：`./kvlang kvspace list /vthread` | **空**（未创建 vthread）|
| 3.4 | `./kvlang load --addr 127.0.0.1:6379 example/kvlang/builtin/print/print_int.kv` | 含 `loaded` |
| 3.5 | `./kvlang load example/kvlang/builtin/` （目录加载）| 含 `loaded N file(s)` |
...
| # | 命令 | 期望 stdout |
|---|------|------------|
| 4.1 | `./kvlang kvspace clear && ./kvlang example/kvlang/builtin/print/print_int.kv` | `X = 42`, `R = 42` |
| 4.2 | `./kvlang --addr 127.0.0.1:6379 example/kvlang/builtin/print/print_int.kv` | `X = 42`, `R = 42` |
| 4.3 | `./kvlang example/kvlang/builtin/arith/add.kv` | `A = 2`, `B = 3`, `C = 5` |
...
| # | 命令 | 期望 stdout |
|---|------|------------|
| 4.5 | `./kvlang kvspace clear && cat example/kvlang/builtin/print/print_int.kv \| ./kvlang` | `X = 42`, `R = 42` |
...
```bash
./kvlang kvspace clear
./kvlang load example/kvlang/builtin/print/print_int.kv
...
| # | 命令 | 期望 |
|---|------|------|
| 6.1 | `./kvlang vet example/kvlang/builtin/print/print_int.kv` | `print_int.kv: OK` |
| 6.2 | `./kvlang vet --dump example/kvlang/builtin/print/print_int.kv` | 含 `File`, `Func`, `Instruction` |
| 6.3 | `./kvlang vet --lower example/kvlang/builtin/print/print_int.kv` | `print_int.kv: OK` |
| 6.4 | `./kvlang vet --dump --lower example/kvlang/controlflow/if_else.kv` | 含 `BlockStmt` 或 `_block_` |
| 6.5 | `cat example/kvlang/builtin/print/print_int.kv \| ./kvlang vet` | `stdin: OK` |
...
| # | 命令 | 期望 |
|---|------|------|
| 7.1 | `./kvlang format example/kvlang/builtin/print/print_int.kv` | 输出格式化后的代码，退出 0 |
| 7.2 | `./kvlang fmt example/kvlang/builtin/print/print_int.kv` | 同 7.1（别名）|
| 7.3 | `cat example/kvlang/builtin/print/print_int.kv \| ./kvlang format` | 同 7.1 |
...
# 关键功能验证：60 秒
./kvlang kvspace clear
./kvlang example/kvlang/builtin/print/print_int.kv      # run file
cat example/kvlang/builtin/print/print_int.kv | ./kvlang  # pipe
./kvlang load example/kvlang/builtin/print/print_int.kv && \
...
| 用途 | 文件 | 预期 stdout |
|------|------|------------|
| 基础函数 + print | `example/kvlang/builtin/print/print_int.kv` | `X = 42`, `R = 42` |
| 算术运算 | `example/kvlang/builtin/arith/add.kv` | `A = 2`, `B = 3`, `C = 5` |
